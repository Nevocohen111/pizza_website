    ...
    return (
        <>
            <div className="ui center aligned icon header" >
                <i className="circular lightbulb icon" style={{ backgroundColor: '#E97451' }}></i>
            </div>
            <div className="flex flex-col items-center justify-center mt-12 slide-in-left" >
                <div className="ui very padded text segment menuHeader" style={{ opacity: "0.8", backgroundColor: '#E97451', width: '20vw' }} >
                    ...
                    <div className="description text-center">
                        <button className="ui positive button" style={{marginLeft:'1rem'}} onClick={handleSubmit}>Submit</button>
                    </div>
                    <br></br>
