                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <div className="ui input focus mb-8 ml-2">
                            <div className="ui toggle checkbox">
                                <input className="ui checkbox" type="checkbox" id="remember" name="remember" value={isCookie} onChange={handleCheckbox} />
                                <label style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: '500' }}>Remember Me</label>
                            </div>
                        </div>
