...
export default function Home(props) {
    ...
    return (
        <>
            {showBanner ? <Banner onClose={() => {setShowBanner(false);setLoadingBtn(false)}} /> : loadingBtn ? <div class="ui active centered inline loader" style={{position:'relative',top:'40rem'}}></div> : null}
